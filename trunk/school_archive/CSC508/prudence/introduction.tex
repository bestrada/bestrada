...
errors. Safety critical systems have been on the bandwagon of using software
in their implementations for some time \cite{Leveson1993}, and disputes have
already occurred regarding their stability. The advent of such systems 
juxtaposed with the complexities of software breeds a new set of concerns that
do not easily map to traditional engineering standards.
...
concern of liability and negligence if a defect exists. In general, this
research seeks to define a prudent process strategy that an organization can
