...
/**
 * TileSoutheasternBoundary is an extension of Tile, representing
 * the southeastern boundary of the map.
 *
 * @author Matt Colón
 */

public class TileSoutheasternBoundary extends Tile
{
    /**
     * Creates a new tile representing the southeastern boundary of the map.
     *
     ...
     */
    protected TileSoutheasternBoundary (Node node, boolean showUnseen) {

        super(node, showUnseen);
        setImage(SBConstants.IMAGE_SOUTHEASTERN_BOUNDARY);
    }
