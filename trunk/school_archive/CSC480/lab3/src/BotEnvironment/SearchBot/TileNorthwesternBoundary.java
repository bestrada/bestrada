...
/**
 * TileNorthwesternBoundary is an extension of Tile, representing
 * the northwestern boundary of the map.
 *
 * @author Matt Colón
 */

public class TileNorthwesternBoundary extends Tile
{
    /**
     * Creates a new tile representing the northwestern boundary of the map.
     *
     ...
     */
    protected TileNorthwesternBoundary (Node node, boolean showUnseen) {

        super(node, showUnseen);
        setImage(SBConstants.IMAGE_NORTHWESTERN_BOUNDARY);
    }
