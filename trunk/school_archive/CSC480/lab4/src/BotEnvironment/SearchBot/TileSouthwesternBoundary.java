...
/**
 * TileSouthwesternBoundary is an extension of Tile, representing
 * the southwestern boundary of the map.
 *
 * @author Matt Colón
 */

public class TileSouthwesternBoundary extends Tile
{
    /**
     * Creates a new tile representing the southwestern boundary of the map.
     *
     ...
     */
    protected TileSouthwesternBoundary (Node node, boolean showUnseen) {

        super(node, showUnseen);
        setImage(SBConstants.IMAGE_SOUTHWESTERN_BOUNDARY);
    }
