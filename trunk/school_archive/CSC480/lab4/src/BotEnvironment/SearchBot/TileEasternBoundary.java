...
/**
 * TileEasternBoundary is an extension of Tile, representing
 * the eastern boundary of the map.
 *
 * @author Matt Colón
 */

public class TileEasternBoundary extends Tile
{
    /**
     * Creates a new tile representing the eastern boundary of the map.
     *
