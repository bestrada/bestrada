...
Future chapters will apply these legal constraints in the software process and show how best practices can be used to fulfill these requirements. In fact, with the proper application of previously documented development practices, software engineers in the safety-critical realm may already be fulfilling their legal duties.
...
The technical progress of modern society has improved greatly in recent years and will continue to improve as new innovations are made. The results of technical progress are products that we use to somehow improve our lives. The automobile and airplane solve our transportation problems. Telephones and the Internet solve our communication problems. Software solves complex problems found in machines and devices that would otherwise be impossible or impractical to implement. There are countless products that are the result of technical innovation which act as solutions to improve our lives. 
...
\section{Summary}
Society has entered an age of high technology where innovation can becomes real in record time. Businesses and organizations capitalize on peoples' want for the faster, easier, and more convenient. But the economic interests of these organizations and the inevitability of human imperfection put people in harm's way.

Defects will manifest themselves in products that people use and lead to injury. The engineers who build these products are held liable for such defects. The law is a system that victims can use to enforce this liability and recover from damages they suffer. This research is motivated by the classification of these defects in a legal context and the possibility of preventing them.
